% Poster: Joint-CS -- Simultaneous Illumination Normalization and
  ...
  \begin{columns}[t]
    ...
    \begin{column}{\colwidth}
      ...
      \begin{enumerate}\setlength{\itemsep}{0.2em}
          \item \textbf{Joint-CS objective.} A single $\ell_1{+}$smooth-prior
      ...
      \begin{itemize}\setlength{\itemsep}{0.12em}
        ...
        \end{itemize}
        Joint-CS estimates $\boldsymbol{c}$ and $\boldsymbol{g}$ together so the
    ...
    \begin{column}{\colwidth}
      ...
      \begin{block}{Method 1: Joint-CS Objective}
    ...
    \begin{column}{\colwidth}
      ...
      \begin{block}{Encoder $\to$ Decoder Pipeline}
        ...
        \begin{figure}
          ...
          \end{tikzpicture}
          \caption{End-to-end Joint-CS. The RAW signal
      ...
      \begin{exampleblock}{Joint vs.\ Sequential: Per-Scene PSNR Gain (dB)}
        ...
        \begin{figure}
          ...
          \begin{tikzpicture}
            ...
            \end{axis}
          \end{tikzpicture}
          \caption{Per-scene PSNR gain of Joint-CS over the sequential
